...
namespace BursaFuarMerkezi.web.Services
{
    ...
    public static class SeoHelper
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> RouteMap = new()
        {
            ...
            ["Pages_Atms"] = new() { ["tr"] = "atm-ler", ["en"] = "atms" },
            ...
            ["Pages_KvkkDocuments"] = new() { ["tr"] = "kvkk-belgeleri", ["en"] = "kvkk-documents" },
            ["Pages_LostItem"] = new() { ["tr"] = "kayip-esya", ["en"] = "lost-item" },
            ["Pages_MeetingRooms"] = new() { ["tr"] = "toplanti-odalari", ["en"] = "meeting-rooms" },
            ...
            ["Pages_QualityPolicy"] = new() { ["tr"] = "kalite-politikasi", ["en"] = "quality-policy" },
