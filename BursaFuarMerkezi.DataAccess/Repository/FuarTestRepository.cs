...
{
    public class FuarTestRepository : Repository<FuarTest>, IFuarTestRepository
    {
        private readonly ApplicationDbContext _db;
        public FuarTestRepository(ApplicationDbContext db) : base(db)
        {
            _db = db;
        }

        public void Update(FuarTest obj)
        {
            var objFromDb = _db.FuarTests.FirstOrDefault(u => u.Id == obj.Id);
            if (objFromDb != null)
            {
